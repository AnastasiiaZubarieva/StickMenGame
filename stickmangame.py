...
class Game:
    def __init__(self):
        self.tk = Tk()
        self.title = ("Містер Руки-палички біжить до виходу")
        ...
        self.sprites = []
        self.running = True
        self.win_text = self.canvas.create_text(250, 250, text="Win!", font=('Helvetica', 30), state='hidden')
